...
class Brand extends BDevs_El_Widget {
    ...
    protected function register_content_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                ...
                'placeholder' => __( 'Desccription Here', 'bdevselement' ),
                'tab' => Controls_Manager::TAB_CONTENT,
                'condition' => [
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'title', 'class', 'section-title mb-20 bdevs-el-title' );
        // ================
        ...
        <div class="partners-ofinner-area">
            <div class="container">
                <div class="row project-grid g-0">
                    ...
                    ?>
                    <div class="col-xxl-2 col-xl-2 col-lg-2 col-md-6 canada unitedstates france unitedkingdom newzealand norway">
