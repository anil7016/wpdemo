...
class InfoBox extends BDevs_El_Widget
{
    ...
    protected function register_content_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __( 'bdevs title goes here', 'bdevselement' ),
    ...
    <?php else:
        ...
        <div class="portfolio">
            <?php if (!empty($image)): ?>
            <div class="portfolio__thumb portfolio__thumb-2">
                <img src="<?php print esc_url($image); ?>" alt="img">

                <a class="popup-image popup-image-2" href="<?php print esc_url($image); ?>">
            ...
            <div class="portfolio__text">
                ...
                <h4><a href="<?php echo esc_url( $settings['title_link'] ); ?>"><?php echo bdevs_element_kses_basic($settings['title']); ?></a></h4>
                <?php endif; ?>

                <?php if ($settings['sub_title']) : ?>
                <span><a href="<?php echo esc_url( $settings['title_link'] ); ?>"><?php echo bdevs_element_kses_basic($settings['sub_title']); ?></a></span>
                <?php endif; ?>
