    ...
    protected function register_content_controls() {
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'label' => __( 'Count Symbol', 'bdevselement' ),
                'default' => __( 'K', 'bdevselement' ),
                'placeholder' => __( 'Type symbol like K', 'bdevselement' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $repeater->add_control(
            ...
            [
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'label' => __( 'Plus symbol', 'bdevselement' ),
                'default' => __( '+', 'bdevselement' ),
                'placeholder' => __( 'Type more like +', 'bdevselement' ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 mb-30">
                        <div class="factt fact-2 abfact-items text-center">
                            <h1 class="counter-count bdevs-el-title"><span class="counter"><?php echo bdevs_element_kses_basic( $slide['number'] ); ?></span>
                             <?php if( !empty($slide['count_symbol']) ) : ?><?php echo esc_html($slide['count_symbol']); ?><?php endif; ?><?php if(!empty($slide['plus_symbol']) ) : ?><?php echo esc_html($slide['plus_symbol']); ?><?php endif; ?>
                           </h1>
