...
class Banner extends BDevs_El_Widget {
    ...
    protected function render() {
        ...
        <div class="pro-banner">
            <a href="<?php echo esc_url($settings['banner_link']); ?>"> 
                <img src="<?php echo esc_url($bg_image); ?>" alt="images"> 
            </a>
            <div class="banner-content">
                ...
                <a href="<?php echo esc_url($settings['banner_link']); ?>"><?php echo bdevs_element_kses_intermediate($settings['banner_button_text']); ?></a>
                <?php endif; ?>
            </div>
        </div>
