...
class Contact_info extends BDevs_El_Widget
{
    ...
    protected function register_content_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'description' => bdevs_element_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'url goes here', 'bdevselement' ),
                'placeholder' => __( 'Set URL', 'bdevselement' ),
                'label_block' => true,
                'dynamic' => [
                    'active' => true,
                ]
        ...
        $this->add_control(
            ...
            [
                ...
                'title_field' => '<# print(tab_content || "Carousel Item"); #>',
                'default' => [
                    [
                        'image' => [
                            'url' => Utils::get_placeholder_image_src(),
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('title', 'class', 'fadeInUp2 wow bdevs-el-title');
                    ...
                    <div class="col-xl-5 offset-xl-1">
                        <div class="section__title section__title-3 mb-55 bdevs-el-content">
                            <?php if (!empty($settings['sub_title'])): ?>
                                <span class="fadeInUp2 wow bdevs-el-subtitle" data-wow-delay=".2s">
        ...
        <div class="contact__gpinfo grey-soft2-bg mb-50">
            ...
            <div class="contact__gpinfo-content">
                ...
                <ul>
                    <?php foreach ($settings['slides'] as $key => $slide) : ?>
                        <?php if (!empty($slide['tab_content'])): ?>
                        <li><a href="<?php echo esc_url( $slide['slide_url'] ); ?>"> <?php echo wp_kses_post($slide['tab_content']); ?></a></li>
                        <?php endif; ?>
                    <?php endforeach; ?>
                </ul>
            </div>
