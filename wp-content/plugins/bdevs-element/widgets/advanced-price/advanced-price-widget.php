                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-xl-8 col-lg-10">
                            <div class="section__title section__title-3 mb-85 text-center bdevs-el-content">
                                <?php if (!empty($settings['sub_title'])): ?>
                                    <span class="bdevs-el-subtitle"><?php echo bdevs_element_kses_basic($settings['sub_title']); ?></span>
                                <?php endif; ?>
                                <?php if (!empty($settings['title'])): ?>
                                    <h2 class="bdevs-el-title"><?php echo bdevs_element_kses_basic($settings['title']); ?></h2>
                                <?php endif; ?>
