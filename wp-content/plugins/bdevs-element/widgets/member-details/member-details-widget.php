...
class Member_Details extends BDevs_El_Widget
{
    ...
    protected function register_content_controls()
    {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'description' => bdevs_element_get_allowed_html_desc( 'intermediate' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'mailto:needhelp@company.com', 'bdevselement' ),
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('button_text', 'class', 'theme-btn blacks-hover mt-10');

        $this->add_render_attribute('button', 'class', 'skill-buttonn');
                     ...
                     <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6">
                              <div class="team__details-content pt-105">
                                 ...
                                 <span class="wow fadeInUp2" data-wow-delay=".4s"><?php echo bdevs_element_kses_basic($settings['job_title']); ?></span>
                                 <?php endif; ?>
                                 ...
                                 <?php if ($settings['bio']) : ?>
                                 <p class="wow fadeInUp2" data-wow-delay=".8s"><?php echo bdevs_element_kses_intermediate($settings['bio']); ?></p>
                                 <?php endif; ?>


                                <div class="team__details-contact mb-45">
                                    <ul>
                                        <?php foreach ($settings['info_list'] as $slide) : ?>
                                        <li class="wow fadeInUp2" data-wow-delay="1s">
                                            ...
                                            <div class="text">
                                                <span>
                                                    <a href="<?php echo esc_url($slide['email_url']); ?><?php echo esc_url($slide['phone_url']); ?>"><?php echo bdevs_element_kses_basic($slide['contact_phone']); ?><?php echo bdevs_element_kses_basic($slide['contact_email']); ?><?php echo bdevs_element_kses_basic($slide['contact_address']); ?></a>
                                                </span>
                                            </div>
                                        </li>
                                        <?php endforeach; ?>
                         ...
                         <div class="col-xl-10 offset-xl-1">
                            <div class="team__details-info mt-60">
                                <?php if ($settings['extra_title']) : ?>
                                  <h4><?php echo bdevs_element_kses_basic($settings['extra_title']); ?></h4>
                                <?php endif; ?>

                                <?php if ($settings['extra_description']) : ?>
                                  <p><?php echo bdevs_element_kses_basic($settings['extra_description']); ?></p>
                                <?php endif; ?>
