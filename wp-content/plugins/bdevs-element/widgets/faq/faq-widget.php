...
class FAQ extends BDevs_El_Widget
{
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('button', 'class', 'z-btn z-btn-border wow fadeInLeft2 bdevs-el-btn');
        ...
        <div class="faq-tab pb-50">
            <ul class="nav nav-pills " id="pills-tab" role="tablist">
                <?php foreach ( $settings['slides2'] as $id => $slide ) :
               ...
               <li class="nav-item" role="presentation">
                 <button 
                 class="nav-link faq-tabs-btn <?php echo esc_attr($active_tab_menu); ?>" 
                 id="pills-home-tab-<?php echo esc_attr($id); ?>" 
                 data-bs-toggle="pill" 
                 data-bs-target="#pills-home-<?php echo esc_attr($id); ?>" 
                 type="button" 
                 role="tab" 
                 aria-controls="pills-home-<?php echo esc_attr($id); ?>" 
        ...
        <div class="tab-content mb-30" id="pills-tabContent">
            ...
            ?>
            <div class="tab-pane fade <?php echo esc_attr($active_tab); ?>" id="pills-home-<?php echo esc_attr($id); ?>" role="tabpanel" aria-labelledby="pills-home-tab-<?php echo esc_attr($id); ?>">
            ...
            <div class="tab-pane fade show active">
                <div class="faq-content faq-white">
                    <div class="accordion" id="accordionExample">
                        ...
                        ?>
                        <div class="accordion-item">
                            <h2 class="accordion-header <?php echo esc_attr($collapsed_tab); ?>" id="heading_<?php echo esc_attr($id); ?>">
                                <button 
