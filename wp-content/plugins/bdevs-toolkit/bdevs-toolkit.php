...
final class Bdevs_toolkit {
	...
	function __construct() {
		...
		*/
		...
		require_once BDEVS_TOOLKIT_DIR . '/widgets/bdevs-country-list.php';
...
function bdevs_custom_post_types() {
	return array (
		'bdevs-countries' => array('title' => 'Country', 'plural_title' => 'Countries', 'rewrite' => 'ourcountries','menu_icon' => 'dashicons-admin-generic'), 
...
function bdevs_custom_taxonomies() {
	return array (
		'country-categories' => array(
			'title' => 'Countries Category', 
			'plural_title' =>'Countries Categories', 
			'rewrite' => 'countries-cat', 
