<?php 
Class Latest_Country_List_Widget extends WP_Widget{

	public function __construct(){
		parent::__construct('bdevs-countries-cats', 'Visapass Country List', array(
			'description'	=> 'Visapass Country List'
		));
	}
                    ...
                    <div class="cat-link">
                        <ul>
							...
							while( $q->have_posts() ):$q->the_post();
					            ...
					            if($_i == 1) {
					            	$_active_class = 'active vrbg';
					            } else {
					            	$_active_class = ' ';
					            }

							?>
                            <li><a class=" <?php echo esc_attr($_active_class); ?>" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></li>
                            <?php 
...
add_action('widgets_init', function(){
	register_widget('Latest_Country_List_Widget');
});