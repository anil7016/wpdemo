<?php
	/**
	 * Visapass Social Widget
	 *
	 *
	 * @author 		basictheme
	 * @category 	Widgets
	 * @package 	visapass/Widgets
	 * @version 	1.0.1
	 * @extends 	WP_Widget
	 */
	...
	class bdevs_services_form_widget  extends WP_Widget{
		...
		public function __construct(){
			parent::__construct('bdevs_services_form_widget',esc_html__('Visapass Services Form','bdevs-toolkit'),array(
				'description' => esc_html__('Visapass Services Form Widget','bdevs-toolkit'),
			));
		}
