<?php
	...
	class Kingfact_Contact_Info_Widget  extends WP_Widget{
		...
		public function __construct(){
			parent::__construct('kingfact_contact_info_widget',esc_html__('Visapass Contact Info', 'bdevs-toolkit'),array(
				'description' => esc_html__('Visapass Contact Info Widget', 'bdevs-toolkit'),
			));
		}
