<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'Visapass_info_Widget');
	function Visapass_info_Widget() {
		register_widget('Visapass_info_Widget');
	}
	
	
	class Visapass_info_Widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('Visapass_info_Widget',esc_html__('Visapass Info','bdevs-toolkit'),array(
				'description' => esc_html__('Visapass Info Widget','bdevs-toolkit'),
			));
		}
