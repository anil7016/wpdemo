...
Class Latest_posts_footer_Widget extends WP_Widget{
	...
	public function __construct(){
		parent::__construct('bdevs-latest-posts-footer', 'Visapass Footer Posts Image', array(
			'description'	=> 'Latest Post Widget by Visapass'
		));
	}
	     	...
	     	<div class="recent-posts recent-posts-footer">
				...
				?>
		            <div class="widget-post-list fix">
		                <div class="widget-posts-image d-none">
