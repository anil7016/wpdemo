...
function visapass_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'slug'               => 'bdevs-toolkit',
			'source'             => esc_url('https://www.devsnews.com/wp/plugins/visapass/bdevs-toolkit.zip'),
			'required'           => true,
			'external_url'       => esc_url('https://www.devsnews.com/wp/plugins/visapass/bdevs-toolkit.zip'),
		),
		array(
			'name'               => esc_html__('Bdevs Element ','visapass'),
			'slug'               => 'bdevs-element',
			'source'             => esc_url('https://www.devsnews.com/wp/plugins/visapass/bdevs-element.zip'),
			'required'           => true,
			'external_url'       => esc_url('https://www.devsnews.com/wp/plugins/visapass/bdevs-element.zip'),
		),
		array(
