...
if ( ! class_exists( 'Visapass_Navwalker_Class' ) ) {
	/**
	 * WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class Visapass_Navwalker_Class extends Walker_Nav_Menu {
		...
		public static function fallback( $args ) {
			if ( current_user_can( 'edit_theme_options' ) ) {
				...
				$fallback_output .= '>';
				$fallback_output .= '<li><a href="' . esc_url( home_url('/') ) . '" title="' . esc_attr__( 'Home', 'visapass' ) . '">' . esc_html__( 'Home', 'visapass'  ) . '</a></li>';
				$fallback_output .= '</ul>';
				if ( $container ) {
					$fallback_output .= '</' . esc_attr( $container ) . '>';
				}
