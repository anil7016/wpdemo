...
<div class="course__more d-flex justify-content-between align-items-center">
   <div class="course__status">
        <?php
            ...
            echo educal_kses_intermediate($price_html);
        ?>
   </div>
    ...
    <ul>
        <li class="d-flex align-items-center">
           ...
           <div class="course__video-info">
              <h5><span><?php _e('Instructor :','educal'); ?></span> <?php echo get_the_author_meta('display_name', get_the_author_meta('ID')); ?></h5>
           </div>
        </li>
        <li class="d-flex align-items-center">
           <div class="course__video-icon">
           ...
           <div class="course__video-info">
              <h5><span><?php _e('Lectures :','educal'); ?></span><?php print esc_html($tutor_lesson_count); ?></h5>
           </div>
        </li>
        ...
        <li class="d-flex align-items-center">
           ...
           <div class="course__video-info">
              <h5><span><?php _e('Duration :','educal'); ?></span><?php echo esc_html($course_duration); ?></h5>
           </div>
        </li>
        <?php endif; ?>
        ...
        <li class="d-flex align-items-center">
           ...
           <div class="course__video-info">
              <h5><span><?php _e('Enrolled :','educal'); ?></span><?php echo (int) tutor_utils()->count_enrolled_users_by_course(); ?> <?php _e('students','educal'); ?></h5>
           </div>
        </li>
        <?php endif; ?>
        ...
        <li class="d-flex align-items-center">
           ...
           <div class="course__video-info">
              <h5><span><?php _e('Course level :','educal'); ?></span><?php echo get_tutor_course_level(); ?></h5>
           </div>
        </li>
        <?php endif; ?>
        ...
        <li class="d-flex align-items-center">
           ...
           <div class="course__video-info">
              <h5><span><?php _e('Language :','educal'); ?></span><?php print esc_html($course_language); ?></h5>
           </div>
        </li>        
    ...
    <div class="course__tab-2 mb-45">
       <ul class="nav nav-tabs" id="courseTab" role="tablist">
          <li class="nav-item" role="presentation">
            <button class="nav-link active" id="description-tab" data-bs-toggle="tab" data-bs-target="#description" type="button" role="tab" aria-controls="description" aria-selected="true"> <i class="icon_ribbon_alt"></i> <span><?php _e('Discription','educal'); ?></span> </button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link " id="curriculum-tab" data-bs-toggle="tab" data-bs-target="#curriculum" type="button" role="tab" aria-controls="curriculum" aria-selected="false"> <i class="icon_book_alt"></i> <span><?php _e('Curriculum','educal'); ?></span> </button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="review-tab" data-bs-toggle="tab" data-bs-target="#review" type="button" role="tab" aria-controls="review" aria-selected="false"> <i class="icon_star_alt"></i> <span><?php _e('Reviews','educal'); ?></span> </button>
          </li>
          <li class="nav-item" role="presentation">
            <button class="nav-link" id="member-tab" data-bs-toggle="tab" data-bs-target="#member" type="button" role="tab" aria-controls="member" aria-selected="false"> <i class="fal fa-user"></i> <span><?php _e('Instructor','educal'); ?></span> </button>
          </li>
        </ul>
    </div>
