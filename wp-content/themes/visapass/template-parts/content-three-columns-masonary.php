    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('postbox post format-image mb-40'); ?>>
        ...
        if(!empty( $massonary_img_id )): ?>
            <div class="postbox__thumb mb-25">
                <a href="<?php the_permalink(); ?>">
                    <img src="<?php print esc_url( $massonary_img ); ?>" alt="<?php print visapass_img_alt_text($massonary_img_id); ?>">
                </a>
            </div>
        <?php 
        endif; ?>
        ...
        <div class="postbox__text ">
            ...
            <div class="read-more mt-30">
                <a href="<?php the_permalink(); ?>" class="btn orange-bg bl-btn"><?php print esc_html($visapass_blog_btn); ?></a>
            </div>
            <?php endif; ?>
