...
if( is_single() ): ?>
    <article id="post-<?php the_ID(); ?>" <?php post_class('blog ablog-4 blog__details--wrapper mb-55 format-search'); ?>>
        <?php 
...
<article id="post-<?php the_ID(); ?>" <?php post_class('blog mb-50 format-search'); ?>>
        <?php 
        if( has_post_thumbnail() ): ?>
            <div class="blog__thumb">
                <a href="<?php the_permalink(); ?>">
